...
% Code: https://github.com/sk8ordie84/falsify
% License: CC BY 4.0
%
...
Code: \href{https://github.com/sk8ordie84/falsify}{github.com/sk8ordie84/falsify}}
...
\begin{itemize}[leftmargin=2em, itemsep=0.2em]
  ...
  \item \texttt{producer.signature} --- detached signature over the canonical bytes by \texttt{producer.id}'s key. Optional in v0.1; mandatory for high-stakes claims in v0.2.
...
\subsection{v0.2 roadmap (target 2026 Q4)}

\begin{itemize}[leftmargin=2em, itemsep=0.2em]
  \item Algorithm agility: a \texttt{hash\_alg} field permitting \texttt{sha256}, \texttt{sha3-256}, or post-quantum candidates.
  \item Tolerance: a \texttt{tolerance} field for floating-point comparison.
  \item Multi-claim manifests: a \texttt{claims:} sequence with shared dataset and seed.
  \item Mandatory signature for high-risk Annex III systems.
  \item Formal canonicalization BNF.
\end{itemize}

\subsection{Open questions}

Post-quantum hash migration. Interoperability with Weights \& Biases, MLflow, and other experiment trackers. On-chain anchoring of chain hashes (deliberately deferred --- the chain hash is sufficient for the vast majority of audit use without introducing a blockchain dependency). Integration with model registries (Hugging Face, ONNX Model Zoo).
...
The full specification text, twelve conformance vectors with locked SHA-256 digests, the reference implementation source, and this preprint's \LaTeX{} source are available at \href{https://github.com/sk8ordie84/falsify}{github.com/sk8ordie84/falsify} (commit hash to be pinned in the camera-ready version). The spec is licensed under CC BY 4.0; the implementation is licensed under MIT.
...
Studio-11 (2026). \emph{PRML v0.1 --- EU AI Act Article 12/17/18/50 Mapping}. \url{https://github.com/sk8ordie84/falsify/blob/main/spec/compliance/AI-Act-mapping-v0.1.md}.
