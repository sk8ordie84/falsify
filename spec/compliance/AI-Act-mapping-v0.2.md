...
| Annex IV 5 / Art. 17(1)(a) | management of modifications; changes over the lifetime | change log of criteria | each criteria version has its own digest; a later record can reference an earlier one (`prior_hash` where used) | why a threshold changed, or who approved it |
